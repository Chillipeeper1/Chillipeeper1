...
<img align="right" src="maga.svg" alt="Ilustración" width="300px">
...
### 💼 Other projects: 
- **TADU (Taxis de Uruapan):** Full-stack web application for local transport management and dispatch, built with React and JavaScript. *(In development)*
